...
parser.add_argument('-c', '--config', default='', type=str, metavar='FILE',
                    help='YAML configuration file specifying default parameters')
...
parser.add_argument('data', nargs='?', metavar='DIR', const=None,
                    help='Dataset path (location *outdated*, please use the --data-dir）')
parser.add_argument('--data-dir', metavar='DIR',
                    help='Dataset Path (root dir)')
parser.add_argument('--dataset', metavar='NAME', default='',
                    help='Dataset Type + Name("<type>/<name>") (default: ImageFolder or ImageTar (if empty))')
group.add_argument('--train-split', metavar='NAME', default='train',
                   help='Data set training split (default: train)')
group.add_argument('--val-split', metavar='NAME', default='validation',
                   help='Data set validation segmentation (default: validation)')
parser.add_argument('--train-num-samples', default=None, type=int,
                    metavar='N', help='Manually specify the number of samples in the training split for IterableDatasets.')
parser.add_argument('--val-num-samples', default=None, type=int,
                    metavar='N', help='Manually specify the number of samples in the validation split for IterableDatasets.')
group.add_argument('--dataset-download', action='store_true', default=False,
                   help='Allows downloading of datasets that support torch/ and tfds/ datasets.')
group.add_argument('--class-map', default='', type=str, metavar='FILENAME',
                   help='Path of the class to the idx mapping file (default: "")')
group.add_argument('--input-img-mode', default=None, type=str,
                   help='The dataset image conversion mode of the input image.')
...
group.add_argument('--model', default='resnet50', type=str, metavar='MODEL',
                   help='要训练的模型名称 (default: "resnet50")')
...
group.add_argument('--input-size', default=[3,224,224], nargs=3, type=int,
                   metavar='N N N',
                   help='Enter all image sizes (d h w, e.g. --input-size 3 224 224), or use the model defaults if they are empty')
...
group.add_argument('-b', '--batch-size', type=int, default=128, metavar='N',
                   help='Input training batch size (default: 128)')
group.add_argument('-vb', '--validation-batch-size', type=int, default=None, metavar='N',
                   help='Verify batch size override (default: none)')
group.add_argument('--channels-last', action='store_true', default=False,
                   help='Memory layout using channels_last')
...
group.add_argument('--grad-checkpointing', action='store_true', default=False,
                   help='Enable gradient checkpoints via model blocks/stages')
group.add_argument('--fast-norm', default=False, action='store_true',
                   help='Launching of experimental fast-track standards')
...
group = parser.add_argument_group('指数移动平均线模型参数')
...
def _parse_args(config_name):
    ...
    # Cache parameters as text strings for later saving in the output directory
    args_text = yaml.safe_dump(args.__dict__, default_flow_style=False)
    return args, args_text

def Run(config_name):
    utils.setup_default_logging()
    args, args_text = _parse_args(config_name)
